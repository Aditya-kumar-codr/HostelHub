        ...
        <div className="min-h-screen bg-gray-50 font-sans pb-10">
            ...
            <main className="w-full max-w-7xl mx-auto px-4 mt-8 space-y-8">
                ...
                <div className="w-full bg-white p-6 md:p-8 shadow-sm rounded-lg border border-gray-100 text-center sm:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold mb-3 text-gray-800">Your Hostel Life, Made Easy.</h2>
                    <p className="text-gray-600 max-w-2xl mx-auto sm:mx-0 mb-5 text-sm sm:text-base">
                        Welcome to HostelHub! Please log in to your account.
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col border border-gray-100 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                ...
                                <p className="text-sm text-gray-600 mb-4 flex-1">Book a time to play badminton or table tennis. Check if sports gear is free to use.</p>
                        ...
                        <div className="flex flex-col border border-gray-100 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                ...
                                <p className="text-sm text-gray-600 mb-4 flex-1">Order snacks and cold drinks from the hostel canteen before you get there.</p>
                                <button className="text-orange-600 text-sm font-bold hover:underline self-start">Log In to Order Food</button>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col border border-gray-100 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                            <div className="h-48 flex items-center justify-center relative overflow-hidden group bg-gray-100">
                                {/*Image */}
                                <img src="https://www.hostel.mitindia.edu/assets/images/girls-hostel/GIRLS%20STUDY%20ROOM.jpeg" alt="Study Area" className="object-cover w-full h-full transition-transform duration-500 group-hover:scale-105" />
                            </div>
                            <div className="p-5 flex-1 flex flex-col">
                                <h4 className="text-lg font-bold text-gray-800 mb-2">Study Room</h4>
                                <p className="text-sm text-gray-600 mb-4 flex-1">Book a quiet seat in the study room to read in peace. See what books are there.</p>
